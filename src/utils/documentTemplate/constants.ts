...
export const FIELD_MENU_ITEMS: FieldMenuItem[] = [
  ...
  { type: 'legal_checkbox', labelDe: 'Rechtliche Checkbox', labelEn: 'Legal checkbox', category: 'form' },
  { type: 'text', labelDe: 'Text (Kurz)', labelEn: 'Text (short)', category: 'text' },
  { type: 'textarea', labelDe: 'Text (Lang)', labelEn: 'Text (long)', category: 'text' },
  { type: 'conditional_section', labelDe: 'Bedingter Abschnitt', labelEn: 'Conditional section', category: 'layout' },
  { type: 'medication_selector', labelDe: 'Medikation', labelEn: 'Medication', category: 'form' },
  { type: 'diagnosis_selector', labelDe: 'Diagnose', labelEn: 'Diagnosis', category: 'form' },
  { type: 'risk_selector', labelDe: 'Risiko', labelEn: 'Risk', category: 'form' },
  { type: 'repeatable_list', labelDe: 'Wiederholbare Liste', labelEn: 'Repeatable list', category: 'form' },

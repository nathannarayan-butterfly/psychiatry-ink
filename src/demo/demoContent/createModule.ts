...
const LAB_NUMERIC: Record<BefundKey, Record<string, LabNumericSpec[]>> = {
  befund1: {
    ...
    leberwerte: [
      { value: '28', numericValue: 28, unit: 'U/l', refMin: 0, refMax: 35 },
      { value: '38', numericValue: 38, unit: 'U/l', refMin: 0, refMax: 45, isAbnormal: true },
      { value: '52', numericValue: 52, unit: 'U/l', refMin: 0, refMax: 55, isAbnormal: true },
...
const DIAGNOSIS_CODES = [
  ...
  { icd10: 'F10.2', icd11: '6C40.2', dsm: '303.90' },
  { icd10: 'F17.2', icd11: '6C4A.2', dsm: '305.1' },
] as const

        ...
        medications: [
          {
            ...
            doseLineGerman: 'Aripiprazol 10 mg 1-0-0',
            prn: false,
          ...
          },
          {
            ...
            formulation: 'tablet' as const,
            strength: '3 mg',
            doseSchedule: { morning: '', noon: '', evening: '3', night: '', unit: 'mg' },
            doseLineGerman: 'Risperidon 3 mg 0-0-1 (ausgeschlichen)',
            prn: false,
    ...
    befundRecords: [
      {
        ...
        fieldValues: {
          ...
          rate: '72',
          qtc: '410',
          findings: 'Keine relevante Pathologie',
        },
        status: 'vidert',
        examDate: '2026-06-08',

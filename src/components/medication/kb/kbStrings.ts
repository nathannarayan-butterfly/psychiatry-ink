...
const STRINGS = {
  ...
  kfActiveMetabolite: {
    de: 'Aktiver Metabolit',
    en: 'Active metabolite',
    fr: 'Métabolite actif',
    es: 'Metabolito activo',
  },
  kfMainTargets: {
    de: 'Wichtigste Rezeptorangriffspunkte',
    en: 'Main receptor targets',
    fr: 'Principales cibles réceptrices',
    es: 'Principales dianas de receptores',
  },
  kfMainCautions: {
    de: 'Wichtige klinische Vorsichtshinweise',
    en: 'Main clinical cautions',
    fr: 'Principales précautions cliniques',
    es: 'Principales precauciones clínicas',
  },
  kfTableLabel: { de: 'Steckbrief', en: 'Key facts', fr: 'Fiche', es: 'Ficha' },

...
export const medicationUiTranslations = {
  ...
  medEducationPanelDesc: {
    de: 'Patientenfreundliche Aufklärungsunterlagen aus Medikationsplan und Wissensdatenbank — einzeln oder als Kombination.',
    en: 'Patient-friendly education sheets from the medication plan and knowledge base — single or combination.',
    fr: 'Documents d\'information patient à partir du plan médicamenteux et de la base de connaissances.',
    es: 'Material de educación al paciente desde el plan y la base de conocimientos.',
  },
  ...
  medEducationWorkspaceHint: {
    de: 'KI-Entwurf zur Formulierung — KB ist Quelle der Wahrheit. Vor Freigabe klinisch prüfen.',
    en: 'AI draft for wording — KB is source of truth. Clinically review before release.',
    fr: 'Brouillon IA — la base de connaissances fait foi. Révision clinique requise.',
    es: 'Borrador IA — la base de conocimientos es la referencia. Revisión clínica requerida.',
  },
  ...
  medEducationFinalize: { de: 'Im Patientenakt speichern', en: 'Save to patient file', fr: 'Enregistrer au dossier', es: 'Guardar en expediente' },

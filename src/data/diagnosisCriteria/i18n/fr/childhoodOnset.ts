...
export const frChildhoodOnset: DisorderTranslationMap = {
  hyperkinetic_disorder_adhd: {
    ...
    groups: {
      ...
      '6a05.inattention':
        'Dimension d’inattention (plusieurs caractéristiques, présentes dans plusieurs situations)',
      '6a05.hyperactivity_impulsivity':
        'Dimension d’hyperactivité / impulsivité (plusieurs caractéristiques, présentes dans plusieurs situations)',
      '6a05.presentation': 'Présentation (forme clinique)',
      '6a05.qualifiers': 'Début développemental, persistance et retentissement',
      '6a05.exclusions': 'Exclusions / diagnostic différentiel',
    },
    criteria: {
      'f90.short_attention':
      ...
      '6a05.inattention_sustaining':
        'Difficultés à maintenir l’attention sur des tâches peu stimulantes ou sans récompense immédiate ; les activités sont souvent non menées à terme',
      '6a05.inattention_distractible':
        'Distractibilité facile par des stimuli externes, erreurs d’inattention par manque d’attention aux détails et apparente absence d’écoute lors d’un échange direct',
      '6a05.inattention_organization':
        'Difficultés à organiser les tâches et les activités, perte fréquente d’objets, oublis dans la vie quotidienne et évitement des efforts mentaux soutenus',
      '6a05.hi_motor':
        'Hyperactivité motrice persistante : gigoter, quitter sa place ou agitation dans des situations où un comportement calme est attendu',
      '6a05.hi_restless':
        'Agitation intérieure ou sensation d’être poussé comme par un moteur, difficultés à s’occuper calmement et bavardage excessif',
      '6a05.hi_impulsive':
        'Action impulsive sans considérer les conséquences possibles : laisser échapper des réponses, difficultés à attendre, interruptions ou intrusions fréquentes envers autrui',
      '6a05.presentation_inattentive':
        'Présentation à prédominance inattentive : les caractéristiques d’inattention prédominent nettement',
      '6a05.presentation_hyperactive':
        'Présentation à prédominance hyperactive-impulsive : les caractéristiques d’hyperactivité / impulsivité prédominent nettement',
      '6a05.presentation_combined':
        'Présentation combinée : les caractéristiques des deux dimensions sont présentes ensemble à un degré cliniquement significatif',
      '6a05.developmental_onset':
        'Début des symptômes durant la période de développement, typiquement avant l’âge d’environ 12 ans (plus large que l’exigence d’un début très précoce de la CIM-10)',
      '6a05.persistence':
        'Les symptômes persistent sur une période prolongée (de l’ordre d’au moins 6 mois)',
      '6a05.pervasiveness':
        'Les symptômes apparaissent dans plusieurs situations et domaines de vie (p. ex. à la maison, à l’école / en formation / au travail et dans les relations sociales)',
      '6a05.impairment':
        'Les symptômes entraînent un retentissement net dans les domaines scolaire, professionnel, social ou d’autres domaines importants du fonctionnement',
      '6a05.exclude_other':
        'Les symptômes ne sont pas mieux expliqués par un autre trouble mental (p. ex. trouble anxieux, affectif ou du spectre de l’autisme) ni par l’effet d’une substance',
    },
  },
  conduct_disorder: {
  ...
  separation_anxiety_disorder: {
    ...
    groups: {
      ...
      '6b05.core':
        'Peur ou anxiété marquée et inadaptée au développement concernant la séparation des figures d’attachement',
      '6b05.qualifiers': 'Début sur la durée de vie, durée et retentissement',
    },
    criteria: {
      'f93_0.worry_harm':
      ...
      '6b05.worry_harm':
        'Inquiétude persistante et excessive concernant le bien-être ou la perte possible de figures d’attachement spécifiques (p. ex. peur d’un accident, d’une maladie ou d’un décès)',
      '6b05.reluctance_separation':
        'Réticence ou refus persistants à s’éloigner des figures d’attachement (p. ex. école, travail, sorties, rester seul ou dormir sans la figure d’attachement)',
      '6b05.somatic_distress':
        'Plaintes physiques répétées ou détresse émotionnelle marquée lors d’une séparation effective ou anticipée d’avec la figure d’attachement',
      '6b05.lifespan_onset':
        'La symptomatologie peut débuter dans l’enfance, mais peut aussi, dans la CIM-11, apparaître ou persister explicitement pour la première fois à l’adolescence ou à l’âge adulte (non limitée à l’enfance)',
      '6b05.developmentally_inappropriate':
        'La peur / l’anxiété est inadaptée au développement ou au contexte et dépasse nettement ce qui serait attendu pour l’âge ou la situation',
      '6b05.duration':
        'Les symptômes persistent sur une période prolongée (de l’ordre de plusieurs mois)',
      '6b05.functional_impact':
        'L’angoisse de séparation entraîne un retentissement net dans les domaines personnel, familial, social, scolaire, professionnel ou d’autres domaines importants du fonctionnement',
    },
  },
  selective_mutism: {

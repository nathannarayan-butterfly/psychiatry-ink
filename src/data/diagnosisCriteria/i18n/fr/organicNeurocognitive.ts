...
export const frOrganicNeurocognitive: DisorderTranslationMap = {
  dementia_alzheimer: {
    ...
    groups: {
      ...
      '6d80.cognitive_domains': 'Déclin cognitif acquis dans au moins deux domaines',
      '6d80.independence': 'Retentissement sur l’autonomie',
      '6d80.aetiology': 'Attribution étiologique : maladie d’Alzheimer',
      '6d80.exclusions': 'Exclusions',
    },
    criteria: {
      ...
      '6d80.domain_memory':
        'Atteinte acquise de l’apprentissage et de la mémoire par rapport au niveau de performance antérieur',
      '6d80.domain_executive':
        'Atteinte des fonctions exécutives telles que la planification, le jugement ou la résolution de problèmes',
      '6d80.domain_attention':
        'Atteinte de l’attention, de la concentration ou de la vitesse de traitement',
      '6d80.domain_language':
        'Atteinte des fonctions langagières (p. ex. manque du mot, dénomination, compréhension)',
      '6d80.domain_social_cognition':
        'Atteinte de la cognition sociale ou des aptitudes visuospatiales/praxiques',
      '6d80.functional_impact':
        'Le déclin cognitif retentit sur l’autonomie dans les activités de la vie quotidienne',
      '6d80.alzheimer_pattern':
        'Début insidieux avec évolution lentement progressive et trouble mnésique précoce au premier plan, compatible avec une maladie d’Alzheimer comme cause sous-jacente',
      '6d80.exclude_delirium_other':
        'L’atteinte n’est pas imputable uniquement à un délirium et n’est pas mieux expliquée par un autre trouble psychique',
    },
  },
  vascular_dementia: {
    ...
    groups: {
      ...
      '6d81.cognitive_domains': 'Déclin cognitif acquis dans au moins deux domaines',
      '6d81.independence': 'Retentissement sur l’autonomie',
      '6d81.vascular_aetiology': 'Attribution étiologique : maladie cérébrovasculaire',
      '6d81.exclusions': 'Exclusions',
    },
    criteria: {
      ...
      '6d81.stepwise_course':
        'Évolution par paliers ou fluctuante, en lien temporel avec des événements cérébrovasculaires',
      '6d81.cerebrovascular_evidence':
        'Éléments anamnestiques, cliniques ou d’imagerie en faveur d’une maladie cérébrovasculaire présumée causale',
  ...
  frontotemporal_dementia: {
    ...
    groups: {
      ...
      '6d83.cognitive_domains': 'Déclin cognitif acquis dans au moins deux domaines',
      '6d83.ftd_presentation': 'Syndrome frontotemporal précoce au premier plan (au moins un)',
      '6d83.course': 'Évolution et préservation relative de la mémoire',
      '6d83.independence': 'Retentissement sur l’autonomie',
      '6d83.exclusions': 'Exclusions',
    },
    criteria: {
      ...
      '6d83.behavioural_change':
        'Modification précoce et dominante du comportement et de la personnalité (désinhibition, apathie, perte des convenances sociales)',
      '6d83.language_decline':
        'Déclin précoce et dominant du langage (manque du mot, production ou compréhension)',
      '6d83.insidious_onset':
        'Début insidieux et évolution lentement progressive',
      '6d83.relative_memory_sparing':
        'La mémoire et l’orientation spatiale sont relativement mieux préservées au stade précoce que les troubles du comportement ou du langage',
      '6d83.functional_impact':
        'Le déclin cognitif ou comportemental retentit sur l’autonomie dans les activités de la vie quotidienne',
      '6d83.exclude_delirium_other':
        'L’atteinte n’est pas imputable uniquement à un délirium et n’est pas mieux expliquée par un autre trouble psychique ou affectif primaire',
    },
  },
  dementia_lewy_bodies: {
    ...
    groups: {
      ...
      '6d82.cognitive_domains': 'Déclin cognitif acquis dans au moins deux domaines',
      '6d82.independence': 'Retentissement sur l’autonomie',
      '6d82.lewy_features': 'Caractéristiques évocatrices de corps de Lewy (au moins 2)',
      '6d82.exclusions': 'Exclusions',
    },
    criteria: {
      ...
      '6d82.fluctuating_cognition':
        'Fluctuations marquées de la cognition, de l’attention et de la vigilance',
      ...
      '6d82.exclude_delirium_substance':
        'L’atteinte n’est pas imputable uniquement à un délirium ni à l’effet de substances/médicaments',
    },
  },

...
export const frNeuroticStressSomatoform: DisorderTranslationMap = {
  'generalized_anxiety_disorder': {
    ...
    groups: {
      ...
      '6b00.core': 'Noyau : appréhension marquée OU anxiété flottante (au moins l’un)',
      '6b00.additional': 'Symptômes caractéristiques additionnels (au moins 3)',
      '6b00.duration': 'Durée',
    ...
    criteria: {
      ...
      '6b00.general_apprehension':
        'Inquiétude ou appréhension marquée portant sur plusieurs domaines de la vie quotidienne (p. ex. famille, santé, finances, travail) et difficile à contrôler',
      '6b00.free_floating':
        'Anxiété ou nervosité générale et flottante, non liée à des inquiétudes ou à des situations particulières',
      '6b00.muscle_tension': 'Tension musculaire ou agitation motrice',
      '6b00.autonomic':
        'Hyperexcitabilité neurovégétative sympathique (p. ex. palpitations, sueurs, tremblements, sécheresse buccale, troubles gastro-intestinaux)',
      '6b00.restlessness': 'Agitation ou sentiment d’être constamment « sur le qui-vive »',
      '6b00.concentration': 'Difficultés de concentration dues aux inquiétudes ou à la tension',
      '6b00.irritability': 'Irritabilité',
      '6b00.sleep':
        'Trouble du sommeil (difficultés d’endormissement ou de maintien du sommeil, ou sommeil agité et non réparateur)',
      '6b00.several_months':
        'Les symptômes sont présents la plupart des jours sur une période d’au moins plusieurs mois',
      '6b00.exclude_other':
        'L’anxiété n’est pas mieux expliquée par un autre trouble mental, une affection somatique (p. ex. hyperthyroïdie) ou l’effet d’une substance/d’un médicament',
    },
  },
  'panic_disorder': {
  ...
  'obsessive_compulsive_disorder': {
    ...
    groups: {
      ...
      '6b20.core': 'Obsessions et/ou compulsions persistantes',
      '6b20.burden': 'Temps consacré ou souffrance/altération cliniquement significative',
      '6b20.insight': 'Spécificateur de prise de conscience (CIM-11)',
    ...
    criteria: {
      ...
      '6b20.obsessions':
        'Obsessions persistantes : pensées, représentations ou impulsions récurrentes, intrusives et indésirables (p. ex. thèmes de contamination, d’agression ou de symétrie) qui suscitent typiquement de l’anxiété ou un malaise',
      '6b20.compulsions':
        'Compulsions persistantes : comportements répétés ou actes mentaux (p. ex. lavage, vérification, comptage, répétition mentale) effectués en réponse à une obsession ou selon des règles rigides',
      '6b20.time_distress':
        'Les symptômes obsessionnels-compulsifs sont chronophages (p. ex. plus d’une heure par jour) ou entraînent une souffrance marquée ou une altération significative des domaines personnel, familial, social ou professionnel',
      '6b20.insight_specifier':
        'Le degré de prise de conscience doit être précisé (bonne ou moyenne vs. faible à absente/délirante) ; même en cas de conviction délirante, le trouble reste codé dans le spectre obsessionnel-compulsif',
      '6b20.exclude_other':
        'La symptomatologie n’est pas mieux expliquée par un autre trouble mental (p. ex. trouble anxieux généralisé, trouble délirant) ni par l’effet d’une substance ou une affection somatique',
    },
  },
  ...
  'post_traumatic_stress_disorder': {
    ...
    groups: {
      ...
      '6b40.exposure': 'Critère lié au facteur de stress (CIM-11)',
      '6b40.reexperiencing': 'Symptôme central 1 : reviviscence dans l’ici et maintenant',
      '6b40.avoidance': 'Symptôme central 2 : évitement',
      '6b40.threat': 'Symptôme central 3 : sentiment persistant de menace actuelle',
      '6b40.duration': 'Durée',
      '6b40.functional': 'Altération du fonctionnement',
    ...
    criteria: {
      ...
      '6b40.traumatic_event':
        'Exposition à un événement extrêmement menaçant ou horrifiant, ou à une série de tels événements',
      '6b40.reexperiencing_now':
        'Reviviscence du traumatisme au présent (et non simple souvenir) sous forme de souvenirs intrusifs intenses, de flashbacks ou de cauchemars, typiquement accompagnés d’une peur ou d’une horreur intense',
      '6b40.avoidance_reminders':
        'Évitement actif des pensées et des souvenirs de l’événement, ou des activités, situations ou personnes qui le rappellent',
      '6b40.current_threat':
        'Perception persistante d’une menace actuelle accrue, p. ex. hypervigilance marquée ou réaction de sursaut exagérée aux stimuli',
      '6b40.several_weeks':
        'Les symptômes persistent sur une période d’au moins plusieurs semaines',
      '6b40.functional_impairment':
        'Altération marquée du fonctionnement personnel, familial, social, scolaire, professionnel ou d’autres domaines importants',
      '6b40.exclude_other':
        'La symptomatologie n’est pas mieux expliquée par un autre trouble mental, une maladie physique ou l’effet d’une substance',
    },
  },
  'adjustment_disorder': {
    ...
    groups: {
      ...
      '6b43.stressor': 'Facteur de stress psychosocial identifiable',
      '6b43.core': 'Noyau : préoccupation par le facteur de stress et échec de l’adaptation',
      '6b43.course': 'Évolution',
    ...
    criteria: {
      ...
      '6b43.identifiable_stressor':
        'Survenue des symptômes dans le mois environ suivant un facteur de stress psychosocial identifiable ou un changement de vie (unique ou multiple)',
      '6b43.preoccupation':
        'Préoccupation excessive par le facteur de stress ou ses conséquences (p. ex. inquiétudes persistantes, pensées pénibles récurrentes au sujet de l’événement, ou rumination constante de sa signification)',
      '6b43.failure_to_adapt':
        'Échec de l’adaptation au facteur de stress, avec altération significative des domaines personnel, familial, social, scolaire ou professionnel',
      '6b43.resolution':
        'Les symptômes régressent en règle générale dans un délai d’environ six mois après la disparition du facteur de stress ou de ses conséquences',
      '6b43.exclude_other':
        'Les symptômes ne remplissent pas les critères d’un autre trouble mental (p. ex. trouble dépressif, TSPT) et dépassent une réaction de stress normale ou un deuil',
    },
  },
  ...
  'somatoform_bodily_distress_disorder': {
    ...
    groups: {
      ...
      '6c20.core': 'Noyau : symptômes corporels pénibles avec attention excessive',
      '6c20.persistence': 'Persistance',
      '6c20.severity': 'Sévérité (CIM-11 : légère / moyenne / sévère)',
    ...
    criteria: {
      ...
      '6c20.bodily_symptoms':
        'Présence d’un ou de plusieurs symptômes corporels pénibles pour la personne (souvent, mais pas nécessairement, multiples et changeants)',
      '6c20.excessive_attention':
        'Attention excessive portée aux symptômes et comportement marqué lié à la santé (p. ex. recours répété à des examens, recherche persistante de réassurance), disproportionné par rapport aux constatations',
      '6c20.persistent_course':
        'Les symptômes et la préoccupation excessive sont persistants (la plupart des jours sur au moins plusieurs mois, de l’ordre de ≥ 3 mois)',
      '6c20.mild':
        'Légère : certaine préoccupation à l’égard des symptômes, mais sans altération substantielle du fonctionnement',
      '6c20.moderate':
        'Moyenne : préoccupation marquée avec altération nette dans certains domaines du fonctionnement',
      '6c20.severe':
        'Sévère : préoccupation envahissante et intrusive avec altération sévère dans de nombreux domaines (p. ex. perte étendue du fonctionnement professionnel/social)',
      '6c20.exclude_other':
        'Les symptômes et la préoccupation associée ne sont pas mieux expliqués par un autre trouble mental (p. ex. trouble panique, trouble dépressif, trouble d’anxiété de maladie)',
    },
  },
  'hypochondriasis_health_anxiety': {
    ...
    groups: {
      ...
      '6b23.core': 'Noyau : préoccupation persistante/crainte d’une maladie grave',
      '6b23.behaviour': 'Comportement du spectre obsessionnel-compulsif (au moins un)',
      '6b23.persistence': 'Persistance et résistance à la réassurance',
    ...
    criteria: {
      ...
      '6b23.illness_preoccupation':
        'Préoccupation persistante par la crainte ou la conviction d’avoir, ou de développer, une ou plusieurs maladies graves, évolutives ou potentiellement mortelles',
      '6b23.checking_reassurance':
        'Comportement répétitif et excessif lié à la santé (p. ex. auto-examens corporels répétés, consultations médicales fréquentes, recherche persistante de réassurance)',
      '6b23.maladaptive_avoidance':
        'Évitement inadapté (p. ex. éviter les rendez-vous médicaux, les hôpitaux ou les informations liées à la maladie) par crainte de voir la préoccupation confirmée',
      '6b23.reassurance_resistant':
        'La préoccupation ou la crainte persiste pendant au moins plusieurs mois et demeure malgré un bilan médical approprié et la réassurance',
      '6b23.exclude_other':
        'La conviction de maladie n’atteint pas une intensité délirante et n’est pas mieux expliquée par un trouble de détresse corporelle, un trouble dépressif ou un autre trouble mental',
    },
  },
  'complex_ptsd': {
    name: 'Trouble de stress post-traumatique complexe',
    differentials: [
      'Trouble de stress post-traumatique (sans perturbations de l’organisation de soi ; CIM-11 6B40)',
      'Trouble de la personnalité émotionnellement labile (borderline)',
      'Modification durable de la personnalité après une expérience de catastrophe (CIM-10 F62.0)',
      'Trouble dépressif ou dissociatif en lien avec un traumatisme',
    ],
    groups: {
      '6b41.exposure': 'Critère de stress : traumatisation prolongée/répétée',
      '6b41.ptsd_core': 'Groupes centraux du TSPT (les trois sont requis)',
      '6b41.dso': 'Perturbations de l’organisation de soi (DSO — les trois sont requises)',
      '6b41.functional': 'Altération du fonctionnement',
      '6b41.exclusions': 'Exclusions',
    },
    criteria: {
      '6b41.prolonged_trauma':
        'Exposition à un événement extrêmement menaçant ou horrifiant, le plus souvent prolongé ou répété et dont il est difficile ou impossible de s’échapper (p. ex. violence domestique persistante, torture, esclavage, abus répétés dans l’enfance)',
      '6b41.reexperiencing':
        'Reviviscence du traumatisme au présent (souvenirs intrusifs intenses, flashbacks ou cauchemars), typiquement accompagnée de peur ou d’horreur',
      '6b41.avoidance':
        'Évitement des pensées et des souvenirs, ou des activités, situations ou personnes qui rappellent le traumatisme',
      '6b41.current_threat':
        'Perception persistante d’une menace actuelle accrue (p. ex. hypervigilance, réaction de sursaut exagérée)',
      '6b41.affect_dysregulation':
        'Dérégulation affective sévère et persistante (p. ex. réactivité émotionnelle accrue, accès de violence, émoussement affectif ou expériences dissociatives sous l’effet du stress)',
      '6b41.negative_self_concept':
        'Concept de soi durablement négatif, avec des croyances de dévalorisation, d’échec ou de diminution, souvent accompagnées de sentiments profonds de honte, de culpabilité ou d’échec',
      '6b41.relationship_disturbance':
        'Difficultés persistantes à maintenir des relations et à se sentir proche d’autrui (p. ex. évitement des relations, sentiment de distance ou faible intérêt pour les relations)',
      '6b41.functional_impairment':
        'Altération marquée du fonctionnement personnel, familial, social, scolaire, professionnel ou d’autres domaines importants',
      '6b41.exclude_other':
        'La symptomatologie n’est pas mieux expliquée par un autre trouble mental ; en l’absence de perturbations de l’organisation de soi, il convient de coder un TSPT (6B40)',
    },
  },
}

...
export const frBehaviouralSyndromes: DisorderTranslationMap = {
  anorexia_nervosa: {
    ...
    groups: {
      ...
      '6b80.core': 'Noyau : insuffisance pondérale significative avec comportement et cognition de maintien du poids',
      '6b80.exclusions': 'Exclusions',
    },
    criteria: {
      'f50_0.low_weight':
      ...
      '6b80.low_weight':
        'Poids corporel significativement bas pour la taille, l’âge et le stade de développement (valeur indicative IMC < 18,5 kg/m² chez l’adulte) ou perte de poids rapide (p. ex. > 20 % en environ six mois), non expliquée par une autre affection ni par un manque de nourriture',
      '6b80.weight_control_behaviours':
        'Schéma comportemental persistant visant à induire ou maintenir le poids anormalement bas (restriction alimentaire, jeûne, vomissements provoqués, mésusage de laxatifs/diurétiques, activité physique excessive)',
      '6b80.cognitive':
        'Surévaluation du poids bas ou préoccupation excessive concernant la silhouette/le poids, OU absence de prise de conscience de la gravité de l’insuffisance pondérale',
      '6b80.exclude_other':
        'L’insuffisance pondérale n’est pas mieux expliquée par une autre maladie somatique, par un manque de nourriture ni par un autre trouble mental',
    },
  },
  bulimia_nervosa: {
    name: 'Boulimie',
    ...
    groups: {
      ...
      '6b81.core': 'Noyau : crises de boulimie fréquentes avec mesures compensatoires sur ≥ 1 mois (en moyenne ≥ 1×/semaine)',
      '6b81.exclusions': 'Exclusions',
    },
    criteria: {
      ...
      '6b81.binge_episodes':
        'Crises de boulimie fréquentes et récurrentes (en moyenne au moins une fois par semaine pendant au moins un mois) avec absorption de grandes quantités de nourriture et perte de contrôle subjective sur le comportement alimentaire',
      '6b81.compensatory':
        'Mesures compensatoires inappropriées répétées pour éviter une prise de poids (vomissements provoqués, mésusage de laxatifs/diurétiques, jeûne, exercice excessif)',
      '6b81.overvaluation':
        'Préoccupation excessive concernant la silhouette ou le poids, influençant de façon inappropriée l’estime de soi',
      '6b81.exclude_low_weight':
        'Le poids corporel n’est pas significativement bas (sinon anorexie mentale, type avec crises de boulimie/purgatif)',
    },
  },
  nonorganic_insomnia: {

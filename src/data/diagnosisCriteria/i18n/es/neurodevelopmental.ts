...
export const esNeurodevelopmental: DisorderTranslationMap = {
  developmental_speech_language_disorder: {
    ...
    groups: {
      ...
      '6a01.core': 'Núcleo: una de las presentaciones del desarrollo del habla o del lenguaje (al menos una)',
      '6a01.qualifiers': 'Condiciones diagnósticas',
      '6a01.exclusions': 'Exclusiones / diagnóstico diferencial',
    },
    criteria: {
      ...
      '6a01.speech_sound':
        'Trastorno del desarrollo de los sonidos del habla: dificultades persistentes para adquirir y producir correctamente los sonidos del habla, claramente por debajo del nivel esperado para la edad',
      '6a01.speech_fluency':
        'Trastorno del desarrollo de la fluidez del habla: alteración persistente e inadecuada para la edad de la fluidez del habla (p. ej., tartamudez con repeticiones de sonidos, prolongaciones o bloqueos)',
      '6a01.language':
        'Trastorno del desarrollo del lenguaje: déficits persistentes en la adquisición, comprensión o uso del lenguaje (receptivo-expresivo, predominantemente expresivo o predominantemente pragmático), claramente por debajo del nivel esperado para la edad',
      '6a01.developmental_onset':
        'Inicio en el período del desarrollo; la alteración no es una pérdida del habla o del lenguaje adquirida más tarde',
      '6a01.functional_impact':
        'Los déficits del habla o del lenguaje afectan de forma notable a la comunicación cotidiana, al rendimiento escolar o a la participación social',
      '6a01.exclude_other_cause':
        'Los déficits no se explican de forma suficiente por una discapacidad intelectual, un déficit auditivo u otro déficit sensorial, una enfermedad neurológica o una exposición lingüística insuficiente',
    },
  },
  developmental_learning_disorder: {
    ...
    groups: {
      ...
      '6a03.core': 'Núcleo: afectación persistente de una habilidad escolar (al menos una)',
      '6a03.qualifiers': 'Condiciones diagnósticas',
      '6a03.exclusions': 'Exclusiones / diagnóstico diferencial',
    },
    criteria: {
      ...
      '6a03.reading':
        'Afectación de la lectura: lectura claramente afectada en cuanto a exactitud, velocidad o comprensión',
      '6a03.written_expression':
        'Afectación de la expresión escrita: dificultades marcadas con la ortografía, la gramática, la puntuación o la organización de los textos escritos',
      '6a03.mathematics':
        'Afectación de las matemáticas: dificultades marcadas con la comprensión numérica, los hechos aritméticos o los procedimientos de cálculo',
      '6a03.below_expected':
        'La habilidad afectada se sitúa de forma marcada y persistente por debajo del nivel esperado para la edad y no mejora lo suficiente a pesar de una intervención específica',
      '6a03.developmental_onset':
        'Las dificultades de aprendizaje comienzan durante la etapa escolar o el período del desarrollo y no se adquieren de forma secundaria más tarde',
      '6a03.functional_impact':
        'El retraso del rendimiento afecta a las exigencias escolares, laborales o cotidianas que requieren estas habilidades',
      '6a03.exclude_other_cause':
        'El retraso no se explica de forma suficiente por una discapacidad intelectual, un déficit sensorial no corregido, una enfermedad neurológica o una enseñanza ausente o insuficiente',
    },
  },
  ...
  autism_spectrum_disorder: {
    ...
    groups: {
      ...
      '6a02.social_communication': 'Dominio 1: déficits persistentes de la comunicación e interacción social recíproca',
      '6a02.restricted_repetitive': 'Dominio 2: patrones restringidos, repetitivos e inflexibles (al menos 2)',
      '6a02.developmental_context': 'Inicio, afectación y calificadores',
      '6a02.exclusions': 'Exclusiones / diagnóstico diferencial',
    },
    criteria: {
      ...
      '6a02.nonverbal_communication':
        'Afectación de la comunicación no verbal y de su integración con el lenguaje (p. ej., contacto ocular, expresión facial, gestos, postura corporal)',
      '6a02.relationships':
        'Dificultad para desarrollar, mantener y comprender las relaciones y para adaptar de forma flexible el comportamiento a los distintos contextos sociales',
      '6a02.stereotypies':
        'Movimientos motores, patrones del habla (p. ej., ecolalia) o uso de objetos estereotipados o repetitivos',
      '6a02.insistence_sameness':
        'Apego excesivo a la invariabilidad, las rutinas o los rituales; malestar acusado ante los cambios',
      '6a02.restricted_interests':
        'Intereses muy restringidos, de intensidad inusual o fijos',
      '6a02.sensory':
        'Hiper- o hiporreactividad a los estímulos sensoriales o interés inusual por aspectos sensoriales del entorno',
      '6a02.developmental_onset':
        'Las características comienzan en el período del desarrollo, pero pueden hacerse plenamente reconocibles más tarde, cuando las exigencias sociales superan las capacidades',
      '6a02.functional_impact':
        'Las características provocan una afectación significativa en áreas personales, familiares, sociales, escolares, laborales u otras áreas importantes del funcionamiento',
      '6a02.separate_qualifiers':
        'El nivel lingüístico e intelectual no es un requisito diagnóstico, sino que se documenta como calificador independiente (con/sin trastorno del desarrollo intelectual, con/sin afectación del lenguaje funcional)',
      '6a02.exclude_better_explained':
        'Las alteraciones no se explican mejor por una discapacidad intelectual aislada, un trastorno del desarrollo del lenguaje u otro trastorno mental',
    },
  },
}

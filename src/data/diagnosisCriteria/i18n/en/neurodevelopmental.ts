...
export const enNeurodevelopmental: DisorderTranslationMap = {
  'developmental_speech_language_disorder': {
    ...
    groups: {
      ...
      '6a01.core': 'Core: one of the developmental speech or language presentations (at least one)',
      '6a01.qualifiers': 'Diagnostic conditions',
      '6a01.exclusions': 'Exclusions / differentiation',
    },
    criteria: {
      ...
      '6a01.speech_sound': 'Developmental speech sound disorder: persistent difficulties acquiring and correctly producing speech sounds, markedly below the level expected for age',
      '6a01.speech_fluency': 'Developmental speech fluency disorder: persistent, age-inappropriate disruption of speech fluency (e.g. stuttering with sound repetitions, prolongations or blocks)',
      '6a01.language': 'Developmental language disorder: persistent deficits in the acquisition, comprehension or use of language (receptive-expressive, predominantly expressive or predominantly pragmatic), markedly below the age level',
      '6a01.developmental_onset': 'Onset in the developmental period; the difficulty is not a loss of speech or language acquired only later',
      '6a01.functional_impact': 'The speech or language deficits markedly impair everyday communication, academic performance or social participation',
      '6a01.exclude_other_cause': 'The deficits are not sufficiently explained by intellectual disability, a hearing or other sensory impairment, a neurological disease or inadequate language exposure',
    },
  },
  'developmental_learning_disorder': {
    ...
    groups: {
      ...
      '6a03.core': 'Core: persistent impairment of a scholastic skill (at least one)',
      '6a03.qualifiers': 'Diagnostic conditions',
      '6a03.exclusions': 'Exclusions / differentiation',
    },
    criteria: {
      ...
      '6a03.reading': 'Impairment in reading: markedly impaired reading in terms of accuracy, speed or comprehension',
      '6a03.written_expression': 'Impairment in written expression: marked difficulties with spelling, grammar, punctuation or the organisation of written text',
      '6a03.mathematics': 'Impairment in mathematics: marked difficulties with number sense, arithmetic facts or calculation procedures',
      '6a03.below_expected': 'The affected skill lies markedly and persistently below the level expected for age and does not improve sufficiently despite targeted intervention',
      '6a03.developmental_onset': 'The learning difficulties begin during the school years or developmental period and are not acquired only secondarily',
      '6a03.functional_impact': 'The performance lag impairs academic, occupational or everyday demands that require these skills',
      '6a03.exclude_other_cause': 'The lag is not sufficiently explained by intellectual disability, an uncorrected sensory impairment, a neurological disease or absent or inadequate instruction',
    },
  },
  ...
  'autism_spectrum_disorder': {
    ...
    groups: {
      ...
      '6a02.social_communication': 'Domain 1: persistent deficits in social communication and reciprocal interaction',
      '6a02.restricted_repetitive': 'Domain 2: restricted, repetitive and inflexible patterns (at least 2)',
      '6a02.developmental_context': 'Onset, impairment and qualifiers',
      '6a02.exclusions': 'Exclusions / differentiation',
    },
    criteria: {
      ...
      '6a02.social_reciprocity': 'Persistent impairment of social-emotional reciprocity (e.g. reduced initiation of contact, shared attention or response to social approach)',
      '6a02.nonverbal_communication': 'Impairment of non-verbal communication and of its integration with language (e.g. eye contact, facial expression, gestures, body posture)',
      '6a02.relationships': 'Difficulty developing, maintaining and understanding relationships and flexibly adapting behaviour to different social contexts',
      '6a02.stereotypies': 'Stereotyped or repetitive motor movements, speech patterns (e.g. echolalia) or use of objects',
      '6a02.insistence_sameness': 'Excessive adherence to sameness, routines or ritualised sequences; marked distress at change',
      '6a02.restricted_interests': 'Highly restricted, unusually intense or fixated interests',
      '6a02.sensory': 'Over- or under-sensitivity to sensory stimuli, or unusual interest in sensory aspects of the environment',
      '6a02.developmental_onset': 'The features begin in the developmental period but may become fully apparent only later when social demands exceed capacities',
      '6a02.functional_impact': 'The features cause significant impairment in personal, family, social, educational, occupational or other important areas of functioning',
      '6a02.separate_qualifiers': 'Language and intellectual functioning are not diagnostic requirements but are documented as separate qualifiers (with/without disorder of intellectual development, with/without impairment of functional language)',
      '6a02.exclude_better_explained': 'The difficulties are not better explained by isolated intellectual disability, a developmental language disorder or another mental disorder',
    },
  },
}

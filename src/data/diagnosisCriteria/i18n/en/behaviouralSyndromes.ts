...
export const enBehaviouralSyndromes: DisorderTranslationMap = {
  anorexia_nervosa: {
    ...
    groups: {
      ...
      '6b80.core': 'Core: significant underweight with weight-maintaining behaviour and cognition',
    ...
    criteria: {
      ...
      '6b80.low_weight':
        'Significantly low body weight for height, age and developmental stage (guide value BMI < 18.5 kg/m² in adults) or rapid weight loss (e.g. > 20% within about six months), not explained by another condition or lack of food',
      '6b80.weight_control_behaviours':
        'Persistent behavioural pattern aimed at inducing or maintaining the abnormally low weight (restricted food intake, fasting, self-induced vomiting, laxative/diuretic misuse, excessive physical activity)',
      '6b80.cognitive':
        'Overvaluation of low body weight or excessive preoccupation with shape/weight, OR a lack of recognition of the seriousness of the underweight',
      '6b80.exclude_other':
        'The underweight is not better explained by another physical illness, by lack of food, or by another mental disorder',
    },
  },
  bulimia_nervosa: {
    ...
    groups: {
      ...
      '6b81.core': 'Core: frequent binge eating with compensatory measures over ≥ 1 month (on average ≥ once/week)',
    ...
    criteria: {
      ...
      '6b81.binge_episodes':
        'Frequent, recurrent binge eating (on average at least once per week over at least one month) with intake of large amounts of food and a subjective loss of control over eating',
      '6b81.compensatory':
        'Repeated inappropriate compensatory measures to prevent weight gain (self-induced vomiting, laxative/diuretic misuse, fasting, excessive exercise)',
      '6b81.overvaluation':
        'Excessive preoccupation with shape or weight that inappropriately influences self-evaluation',
      '6b81.exclude_low_weight':
        'Body weight is not significantly low (otherwise anorexia nervosa, binge-purge type)',
    },
  },
  nonorganic_insomnia: {

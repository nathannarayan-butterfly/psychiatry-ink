...
export const enSubstanceUse: DisorderTranslationMap = withIcd11SubstanceTranslations(enSubstanceUseBase, {
  substanceNames: {
    ...
    cocaine_harmful_use: 'cocaine',
    stimulants_harmful_use: 'other stimulants including caffeine',
  ...
  depImpairedControl: (s) =>
    `Impaired control over ${s} use (onset, amount, circumstances or cessation), often accompanied by a strong desire to use (craving)`,
  depSalience:
    'Increasing priority given to use over other interests and obligations, with continued use despite the occurrence of harmful consequences',
  depPhysiological:
    'Physiological features: tolerance, withdrawal symptoms on reducing or stopping use, or repeated use to prevent or relieve withdrawal',
  harmPatternGroupLabel:
    'Sustained pattern of use (episodic or continuous, typically over ≥ 12 months — or ≥ 1 month if continuous)',
  harmGroupLabel: 'Demonstrable harm (at least one of the following areas)',
  exclusionsGroupLabel: 'Exclusions',
  usePattern: (s) => `A repeated or sustained pattern of ${s} use is documented`,
  harmSelf:
    'Clinically significant damage to the physical or mental health of the person as a result of use (including use- or intoxication-related behaviour)',
  harmOthers:

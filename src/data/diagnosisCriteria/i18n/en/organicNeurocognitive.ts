...
export const enOrganicNeurocognitive: DisorderTranslationMap = {
  dementia_alzheimer: {
    ...
    groups: {
      ...
      '6d80.cognitive_domains': 'Acquired cognitive decline in at least two domains',
      '6d80.independence': 'Impairment of independence',
      '6d80.aetiology': 'Aetiological attribution: Alzheimer’s disease',
    ...
    criteria: {
      ...
      '6d80.domain_memory':
        'Acquired impairment of learning and memory relative to the previous level of performance',
      '6d80.domain_executive':
        'Impairment of executive functions such as planning, judgement or problem-solving',
      '6d80.domain_attention':
        'Impairment of attention, concentration or processing speed',
      '6d80.domain_language':
        'Impairment of language functions (e.g. word-finding, naming, comprehension)',
      '6d80.domain_social_cognition':
        'Impairment of social cognition or of visuospatial/practical abilities',
      '6d80.functional_impact':
        'The cognitive decline interferes with independence in activities of daily living',
      '6d80.alzheimer_pattern':
        'Insidious onset with a slowly progressive course and early predominant memory impairment, consistent with Alzheimer’s disease as the underlying cause',
      '6d80.exclude_delirium_other':
        'The impairment is not solely attributable to a delirium and is not better explained by another mental disorder',
    },
  },
  vascular_dementia: {
    ...
    groups: {
      ...
      '6d81.cognitive_domains': 'Acquired cognitive decline in at least two domains',
      '6d81.independence': 'Impairment of independence',
      '6d81.vascular_aetiology': 'Aetiological attribution: cerebrovascular disease',
    ...
    criteria: {
      ...
      '6d81.stepwise_course':
        'Stepwise or fluctuating course with a temporal relationship to cerebrovascular events',
      '6d81.cerebrovascular_evidence':
        'History, clinical or imaging evidence of cerebrovascular disease presumed to be causative',
  ...
  frontotemporal_dementia: {
    ...
    groups: {
      ...
      '6d83.cognitive_domains': 'Acquired cognitive decline in at least two domains',
      '6d83.ftd_presentation': 'Early-leading frontotemporal syndrome (at least one)',
      '6d83.course': 'Course and relative sparing of memory',
      '6d83.independence': 'Impairment of independence',
    ...
    criteria: {
      ...
      '6d83.behavioural_change':
        'Early-leading change in behaviour and personality (disinhibition, apathy, loss of social graces)',
      '6d83.language_decline':
        'Early-leading decline in language (word-finding, speech production or comprehension)',
      '6d83.insidious_onset':
        'Insidious onset and a slowly progressive course',
      '6d83.relative_memory_sparing':
        'Memory and spatial orientation are relatively better preserved in the early stage than the behavioural or language disturbance',
      '6d83.functional_impact':
        'The cognitive or behavioural decline interferes with independence in activities of daily living',
      '6d83.exclude_delirium_other':
        'The impairment is not solely attributable to a delirium and is not better explained by another mental or primary affective disorder',
    },
  },
  dementia_lewy_bodies: {
    ...
    groups: {
      ...
      '6d82.cognitive_domains': 'Acquired cognitive decline in at least two domains',
      '6d82.independence': 'Impairment of independence',
      '6d82.lewy_features': 'Characteristic Lewy body features (at least 2)',
    ...
    criteria: {
      ...
      '6d82.fluctuating_cognition':
        'Marked fluctuations in cognition, attention and alertness',
      ...
      '6d82.exclude_delirium_substance':
        'The impairment is not solely attributable to a delirium or to the effects of substances/medication',
    },
  },

...
/**
 * Shared EN strings for the DISTINCT ICD-11 6D10/6D11 dimensional sets attached to
 * each categorical F60.x disorder. The general/severity/exclusion text is identical
 * across disorders (only the per-disorder id slug differs); the selected trait
 * domains encode the categorical→dimensional crosswalk.
 */
type Icd11TraitKey =
...
const ICD11_PD_GROUP_TEXT = {
  general:
    'General criteria for a personality disorder (ICD-11 6D10: impairment of self and/or interpersonal functioning)',
  severity: 'Severity grading (exactly one level; 6D10)',
  traits: 'Trait domain qualifiers (one or more; 6D11)',
  exclusions: 'Exclusions / differentiation',
}

const ICD11_PD_CORE_TEXT = {
  self: 'Impairment in aspects of the self (identity, self-worth, an accurate self-view, self-direction and the capacity to set goals)',
  interpersonal:
    'Impairment in interpersonal functioning (establishing and maintaining close, mutually satisfying relationships, understanding others’ perspectives and managing conflict)',
  duration:
    'The pattern has been present over an extended period (of the order of ≥ 2 years), is pervasive across situations and is not confined to a circumscribed triggering situation',
}

const ICD11_PD_SEVERITY_TEXT = {
  mild: 'Mild: impairment in some areas of self and/or interpersonal functioning, with preserved functioning in many areas; generally no substantial risk of harm to self or others (6D10.0)',
  moderate:
    'Moderate: marked problems across several areas of functioning, with pronounced impairment in most interpersonal relationships and social/occupational roles (6D10.1)',
  severe:
    'Severe: severe impairment of self and interpersonal functioning across nearly all areas of life; often a substantial risk of harm to self or others (6D10.2)',
}
...
const ICD11_PD_TRAIT_TEXT: Record<Icd11TraitKey, string> = {
  negative_affectivity:
    'Negative affectivity: a tendency towards a broad range of negative emotions at a disproportionate frequency and intensity (e.g. anxiousness, emotional lability, mistrust, low self-worth) (6D11.0)',
  detachment:
  ...
  dissociality:
    'Dissociality: disregard for the rights and feelings of others, self-centredness, a lack of empathy and a lack of consideration (including pervasive mistrust of or disdain for others) (6D11.2)',
  disinhibition:
  ...
  anankastia:
    'Anankastia: a focus on rigid standards of perfection, order, regularity and control over one’s own and others’ behaviour (6D11.4)',
  borderline_pattern:
...
export const enPersonality: DisorderTranslationMap = {

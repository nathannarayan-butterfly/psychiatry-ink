...
> = {
  'aberrant-salience-psychotic-meaning': {
    ...
    de: {
      ...
      longitudinalPattern:
        'Zunahme über 2 Wochen bei Schlafmangel und Stimulanzienkonsum; partielle Besserung nach Antipsychotikumwechsel.',
      uncertainty:
  ...
  'substance-addictive-contribution': {
    ...
    de: {
      ...
      longitudinalPattern:
        'Täglicher Cannabiskonsum und episodischer Amphetaminkonsum in den Wochen vor Aufnahme.',
